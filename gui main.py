...
w = tk.Label(root, text="Yoga Pose Detection Using Machine Learning",width=40,background="skyblue",height=2,font=("Times new roman",19,"bold"))
w.place(x=0,y=15)
...
wlcm=tk.Label(root,text="......Welcome to Yoga Pose Detection System ......",width=85,height=3,background="skyblue",foreground="black",font=("Times new roman",22,"bold"))
